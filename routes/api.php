...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('create-emergency-booking', [ API\EmergencyBookingController::class, 'createEmergencyBooking' ]);
    Route::post('find-emergency-providers', [ API\EmergencyBookingController::class, 'findNearbyProviders' ]);
    Route::post('emergency-booking-action', [ API\EmergencyBookingController::class, 'emergencyBookingAction' ]);
    Route::get('emergency-booking-list', [ API\EmergencyBookingController::class, 'getEmergencyBookingList' ]);
    Route::post('handle-emergency-booking', [ API\EmergencyBookingController::class, 'handleEmergencyBooking' ]);

    // Provider location
    Route::post('update-provider-location', [API\ProviderLocationController::class, 'updateProviderLocation']);

    // Admin Emergency Booking Routes
    Route::get('admin/emergency-bookings', [API\EmergencyBookingController::class, 'adminEmergencyBookingList']);
    Route::post('admin/emergency-booking-action', [API\EmergencyBookingController::class, 'adminEmergencyBookingAction']);
    Route::get('admin/emergency-booking-stats', [API\EmergencyBookingController::class, 'emergencyBookingStats']);
});
