...
Route::group(['middleware' => ['auth']], function () {
    Route::get('emergency-bookings', [App\Http\Controllers\EmergencyBookingController::class, 'emergencyBookings'])->name('emergency.bookings');
    Route::get('emergency-bookings-data', [App\Http\Controllers\EmergencyBookingController::class, 'emergencyBookingsData'])->name('emergency.bookings_data');
    Route::get('emergency-booking/{id}', [App\Http\Controllers\EmergencyBookingController::class, 'show'])->name('emergency-booking.show');
    Route::post('emergency-booking-action', [App\Http\Controllers\EmergencyBookingController::class, 'adminEmergencyBookingAction'])->name('emergency-booking.action');
    Route::get('emergency-booking-stats', [App\Http\Controllers\EmergencyBookingController::class, 'emergencyBookingStats'])->name('emergency-booking.stats');
});
